...
- 🧪 Validated performance under varying load conditions

`LTspice` `Proteus` `Analog Circuit Design` `Power Electronics`
...
- 🔀 Logical: **AND / OR / XOR**
- ✅ Validated via **Truth Table Analysis** and **Timing Diagrams**
- 📐 Designed using combinational logic principles

`Digital Logic` `Computer Architecture` `Proteus` `Circuit Simulation`
...
![GitHub Streak](https://streak-stats.demolab.com?user=GetzXyz&theme=tokyonight&hide_border=true)
...
I'm open to **internships**, **research collaborations**, and **freelance hardware/firmware projects**.
